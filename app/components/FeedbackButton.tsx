                ...
                <form onSubmit={handleSubmit}>
                  <div className="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                      Found a bug, have a feature idea, or just want to leave a comment? Let us know.
                    </p>

                    <div className="mt-4 space-y-4">
                      <fieldset>
                        <legend className="text-sm font-medium text-gray-700 dark:text-gray-300">Feedback Type</legend>
                        <div className="mt-2 space-y-2"> {/* Changed to space-y-2 for vertical list if needed, or keep flex gap-4 for horizontal */}
