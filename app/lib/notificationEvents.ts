export const NOTIFICATION_EVENT_TYPES = {
  ...
  SPECIAL_REPORT_ACTION_REQUIRED: 'special_report.action_required',
  SPECIAL_REPORT_REVIEWED: 'special_report.reviewed',
  EVENT_ACTION_REQUIRED: 'event.action_required',
...
export const PREFERENCE_CATEGORIES: {
...
}[] = [
  {
    key: 'new_report',
    title: 'New Reports',
    description: 'When a report is filed against you, a cadet you oversee receives a report, a report needs your approval, an incident report needs TAC review, or a special report/event requires leadership action.',
  ...
  },
  {
    ...
    description: 'When a report or incident report you submitted is approved, rejected, returned, actioned, when an appeal is decided, or when your special report is reviewed.',
