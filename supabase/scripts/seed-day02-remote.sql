-- Day 02 remote seed: teachers, coaches, classes, sports, oversight fixtures
-- Password for newly created accounts: password123
-- Run after Day 02 migrations are applied (supabase db push).

BEGIN;

-- sync_cadet_oversight matches approval_groups.group_name = companies.company_name || ' TAC'
...
SELECT public.ensure_staff_profile('d1020000-0000-0000-0000-000000000001');
SELECT public.ensure_staff_profile('d1020000-0000-0000-0000-000000000002');
SELECT public.ensure_staff_profile('d1020000-0000-0000-0000-000000000003');
SELECT public.ensure_staff_profile('d1020000-0000-0000-0000-000000000004');
SELECT public.ensure_staff_profile(u.id)
FROM auth.users u
