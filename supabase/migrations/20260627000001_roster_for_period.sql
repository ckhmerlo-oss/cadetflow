-- Day 07 follow-up: roster with period-scoped conduct/demerit stats (same shape as get_full_roster)
...
grant execute on function public.get_roster_for_period(text, smallint, boolean) to authenticated;
