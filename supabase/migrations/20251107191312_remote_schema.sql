  ...
  RETURN QUERY SELECT
    ...
    (SELECT COALESCE(SUM(ot.demerits), 0)::int
     ...
     WHERE r.subject_cadet_id = p_cadet_id
       ...
       -- Handle cases (like summer) where there is no current term
