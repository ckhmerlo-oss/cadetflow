...
BEGIN
  ...
  IF first_approver_group_id IS NULL THEN
    ...
    PERFORM public.calculate_tours_for_new_report(p_subject_cadet_id, v_demerits, (SELECT policy_category FROM offense_types WHERE id = p_offense_type_id), p_date_of_offense);
