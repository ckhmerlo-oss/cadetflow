...
"[project]/app/manage/roles/data:f193c9 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/manage/roles/data:52f5ac [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/manage/roles/data:f8ee4a [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$manage$2f$roles$2f$data$3a$f8ee4a__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/manage/roles/data:f8ee4a [app-client] (ecmascript) <text/javascript>");
;
...
function AddGroupModal({ isOpen, onClose, companyId, childGroupId, onSuccess }) {
    ...
    const handleSubmit = async (e)=>{
        ...
        if (!name.trim()) return;
        setLoading(true);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$manage$2f$roles$2f$data$3a$f8ee4a__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createGroupAction"])(companyId, name, childGroupId);
        setLoading(false);
        if (result?.error) {
            alert(result.error);
        } else {
...
"[project]/app/manage/roles/data:c23054 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/manage/roles/data:01b1cb [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/manage/roles/data:604a8d [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$manage$2f$roles$2f$data$3a$c23054__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/manage/roles/data:c23054 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$manage$2f$roles$2f$data$3a$01b1cb__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/manage/roles/data:01b1cb [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$manage$2f$roles$2f$data$3a$604a8d__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/manage/roles/data:604a8d [app-client] (ecmascript) <text/javascript>");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function RoleListModal({ isOpen, onClose, onRoleUpdate, groupName, groupId, companyName, companyId }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RoleListModal.useEffect": ()=>{
            if (isOpen) {
                setLoading(true);
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$manage$2f$roles$2f$data$3a$c23054__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getGroupRoles"])(groupId).then({
    ...
    const handleAdd = async ()=>{
        setLoading(true);
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$manage$2f$roles$2f$data$3a$604a8d__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createRoleAction"])(companyId, groupId, previewName, customLevel);
        if (res.error) {
            alert(res.error);
        } else {
            const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$manage$2f$roles$2f$data$3a$c23054__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getGroupRoles"])(groupId);
    ...
    const handleDelete = async (roleId)=>{
        ...
        setLoading(true);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$manage$2f$roles$2f$data$3a$01b1cb__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["deleteRoleAction"])(roleId);
        const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$manage$2f$roles$2f$data$3a$c23054__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getGroupRoles"])(groupId);
        setRoles(updated.roles);
        // --- TRIGGER PARENT REFRESH IMMEDIATELY ---
        onRoleUpdate();
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$manage$2f$roles$2f$data$3a$f193c9__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/manage/roles/data:f193c9 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$manage$2f$roles$2f$data$3a$52f5ac__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/manage/roles/data:52f5ac [app-client] (ecmascript) <text/javascript>");
...
function ChainVisualizer({ initialCompanies }) {
    ...
    async function fetchChain() {
        setLoading(true);
        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$manage$2f$roles$2f$data$3a$f193c9__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getCompanyChain"])(selectedCompanyId);
        setNodes(data || []);
        setLoading(false);
    }
    ...
    const handleDelete = async (id)=>{
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$manage$2f$roles$2f$data$3a$52f5ac__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["deleteGroupAction"])(id);
        fetchChain();
    };
...
//# sourceMappingURL=app_manage_roles_a6413b8a._.js.map