...
"[project]/app/incidents/data:6481fa [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$incidents$2f$data$3a$6481fa__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/incidents/data:6481fa [app-client] (ecmascript) <text/javascript>");
...
function IncidentsClient({ incidents, roleLevel, offenseTypes }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "IncidentsClient.useEffect": ()=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$incidents$2f$data$3a$6481fa__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getFacultyList"])().then(setFaculty);
        }
    }["IncidentsClient.useEffect"], []);
    ...
    const handleResolve = async ()=>{
        ...
        setLoading(true);
        const { error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$incidents$2f$data$3a$b09e86__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["resolveAsHandled"])(selectedIncident.id, resolutionNotes, handledById);
        setLoading(false);
    ...
    const handleConvert = async ()=>{
        ...
        setLoading(true);
        const { error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$incidents$2f$data$3a$521f3a__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["convertToDemerit"])(selectedIncident.id, selectedOffenseId, resolutionNotes);
        setLoading(false);
        if (error) alert(error);
        else {
            setSelectedIncident(null);
...
//# sourceMappingURL=_8be903f6._.js.map