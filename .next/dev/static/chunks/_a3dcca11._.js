...
;
;
function OnboardingTour({ show, canManage, showDailyReports, isSiteAdmin, roleLevel }) {
    _s();
    ...
    steps.push({
        ...
        content: 'This is your home base. Check here for reports waiting for your approval or status updates on your own profile.',
        placement: 'bottom',
        action: 'next'
    });
    // 2. Submit Reports (If allowed)
    if (roleLevel >= 15) {
        // Step 2a: Point to the menu
        steps.push({
            id: 'nav-to-submit',
            path: '/',
            targetId: 'header-menu-button',
            title: 'Submitting Reports',
            content: 'To file a new demerit report, open the menu and select "Submit Report" (or click the button below to go there now).',
            placement: 'left',
            action: 'navigate',
            nextPath: '/submit'
        });
        // Step 2b: Explain the page
        steps.push({
            id: 'explain-submit',
            path: '/submit',
            targetId: 'submit-form-container',
            title: 'The Report Form',
            content: 'Fill out the cadet details here. The system automatically routes the report to the correct Squad Leader or Commander based on rank.',
            placement: 'right',
            action: 'next'
        });
    }
    // 3. Daily Reports (If allowed)
    if (showDailyReports) {
        steps.push({
            id: 'nav-to-green-sheet',
            path: roleLevel >= 15 ? '/submit' : '/',
            targetId: 'header-menu-button',
            title: 'Daily Reports',
            content: 'Staff and TACs can access the "Green Sheet" from the main menu.',
            placement: 'left',
            action: 'navigate',
            nextPath: '/reports/daily'
        });
        steps.push({
            id: 'explain-green-sheet',
            path: '/reports/daily',
            targetId: 'daily-reports-container',
            title: 'The Digital Green Sheet',
            content: 'View all active punishments here. Use this page to log served tours in bulk or print the daily roster.',
            placement: 'bottom',
            action: 'next'
        });
    }
    // 4. Manage Roster (If allowed)
    if (canManage) {
        steps.push({
            id: 'nav-to-manage',
            path: showDailyReports ? '/reports/daily' : '/',
            targetId: 'header-menu-button',
            title: 'Roster Management',
            content: 'Admins can manage personnel from the "Manage Roster" menu link.',
            placement: 'left',
            action: 'navigate',
            nextPath: '/manage'
        });
        steps.push({
            id: 'explain-manage',
            path: '/manage',
            targetId: 'manage-roster-container',
            title: 'Roster Controls',
            content: 'Use these filters to find cadets, bulk-assign roles, or move members between companies.',
            placement: 'bottom',
            action: 'next'
        });
    }
    ...
    steps.push({
        ...
        content: 'That covers the basics. Click Finish to get started.',
        placement: 'bottom',
        action: 'finish'
    });
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OnboardingTour.useEffect": ()=>{
            ...
            const timer = setTimeout({
                "OnboardingTour.useEffect.timer": ()=>{
                    ...
                    if (element) {
                        ...
                        if (r.width > 0 && r.height > 0) {
                            ...
                            // Element exists but hidden (e.g. mobile menu closed)
                            // Fallback: just center screen?
                            setRect({
            ...
            }["OnboardingTour.useEffect.timer"], 500) // Delay for route transition
            ;
            return ({
                "OnboardingTour.useEffect": ()=>clearTimeout(timer)
            })["OnboardingTour.useEffect"];
        }
    }["OnboardingTour.useEffect"], [
        currentStepIndex,
    ...
    const handleNext = async ()=>{
        if (currentStep.action === 'navigate' && currentStep.nextPath) {
            // Move index forward, logic will trigger route push
    ...
    // Calculate Popover Position based on 'placement' prop
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                style: {
                    top: rect ? rect.top - 4 : '50%',
                    left: rect ? rect.left - 4 : '50%',
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "absolute pointer-events-auto transition-all duration-500 ease-out w-80",
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "bg-gray-50 dark:bg-gray-900/50 px-5 py-3 flex justify-end",
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                onClick: handleNext,
                                ...
                                children: currentStep.action === 'finish' ? 'Finish' : currentStep.action === 'navigate' ? 'Go There →' : 'Next'
                            }, void 0, false, {
                                fileName: "[project]/app/components/tour/OnboardingTour.tsx",
                                lineNumber: 272,
                                columnNumber: 13
...
_s(OnboardingTour, "0AEyYOhOoacIRi5O1LPTL5TzPjo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"]
    ];
...
//# sourceMappingURL=_a3dcca11._.js.map