...
;
;
// Configuration for the new Category System
...
function InfractionsTab() {
    ...
    const [createCategoryKey, setCreateCategoryKey] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('1') // Defaults to Cat 1
    ;
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        fetchInfractions();
    }, []);
    async function fetchInfractions() {
        setLoading(true);
        const { data, error } = await supabase.from('offense_types').select('*').order('policy_category', {
            ascending: true
        }).order('demerits', {
            ascending: true
        }).order('offense_name', {
    ...
    const getCategoryKeyFromCode = (code)=>{
        // Reverse lookup the config key from the stored code (e.g. "2a" -> "2a")
        // If custom/legacy, fallback to '1' or logic based on demerits? 
        // For now, simple direct match.
    ...
    const handleCreate = async ()=>{
        if (!createName) {
            alert("Offense Name is required.");
            return;
        }
        ...
        const { error } = await supabase.rpc('admin_create_infraction', {
            ...
            p_offense_code: config.code // "1", "2a", "2b", etc.
        });
        if (error) {
    ...
    const saveEdit = async ()=>{
        if (!editingId) return;
        // Get derived values from the selected category
        const config = CATEGORY_CONFIG[editCategoryKey];
        const { error } = await supabase.from('offense_types').update({
        ...
        if (error) {
            ...
            // Optimistic update with new derived values
...
(()=>{
    const e = new Error("Cannot find module './tabs/Rolestab'");
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        activeTab === 'roles' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(RolesTab, {}, void 0, false, {
                            fileName: "[project]/app/admin/AdminClientComponent.tsx",
                            lineNumber: 87,
                            columnNumber: 37
                        }, this)
...
//# sourceMappingURL=_4772852e._.js.map