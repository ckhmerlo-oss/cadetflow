...
(()=>{
    const e = new Error("Cannot find module './admin-client-component'");
...
async function AdminPage() {
    ...
    const { data: profile } = await supabase.from('profiles').select('roles(can_manage_all_rosters)').eq('id', user.id).single();
    const isSiteAdmin = profile?.roles?.can_manage_all_rosters || false;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(AdminSettingsClient, {
        user: user
    }, void 0, false, {
