...
"[project]/app/manage/probation/data:6d3ec3 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$manage$2f$probation$2f$data$3a$6d3ec3__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/manage/probation/data:6d3ec3 [app-ssr] (ecmascript) <text/javascript>");
...
function ProbationClient({ initialData, cadetOptions, canEdit }) {
    ...
    const handleSubmit = async ()=>{
        ...
        setLoading(true);
        const { error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$manage$2f$probation$2f$data$3a$6d3ec3__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updateCadetProbation"])(selectedCadetId, status, notes);
        setLoading(false);
        if (error) {
            alert(error);
        } else {
...
//# sourceMappingURL=_60075aad._.js.map