...
function IncidentDetailsClient({ incident, userRoleLevel, facultyList, offenseTypes }) {
    ...
    const handleResolve = async ()=>{
        setLoading(true);
        const { error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$incidents$2f$data$3a$adef33__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["resolveAsHandled"])(incident.id, notes, handledBy);
    ...
    const handleConvert = async ()=>{
        setLoading(true);
        const { error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$incidents$2f$data$3a$90df76__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["convertToDemerit"])(incident.id, offenseId, notes);
        if (error) alert(error);
...
//# sourceMappingURL=_e6a971e7._.js.map