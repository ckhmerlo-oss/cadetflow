module.exports = [
"[project]/app/incidents/data:b09e86 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$incidents$2f$data$3a$b09e86__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/incidents/data:b09e86 [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$incidents$2f$data$3a$521f3a__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/incidents/data:521f3a [app-ssr] (ecmascript) <text/javascript>");
...
function IncidentDetailsClient({ incident, userRoleLevel, facultyList, offenseTypes }) {
    ...
    const [handledBy, setHandledBy] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(incident.reporter_id) // Default to reporter
    ;
    ...
    const handleResolve = async ()=>{
        setLoading(true);
        const { error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$incidents$2f$data$3a$b09e86__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["resolveAsHandled"])(incident.id, notes, handledBy);
    ...
    const handleConvert = async ()=>{
        setLoading(true);
        const { error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$incidents$2f$data$3a$521f3a__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["convertToDemerit"])(incident.id, offenseId, notes);
        if (error) alert(error);
...
//# sourceMappingURL=_8ed34cfc._.js.map