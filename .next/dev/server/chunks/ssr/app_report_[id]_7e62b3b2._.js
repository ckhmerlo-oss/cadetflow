module.exports = [
"[project]/app/report/[id]/data:e4b451 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$report$2f5b$id$5d2f$data$3a$e4b451__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/report/[id]/data:e4b451 [app-ssr] (ecmascript) <text/javascript>"); // <-- ADDED: Import the action
'use client';
;
;
;
...
function ReportDetailsClient({ user, initialReport, initialLogs, initialAppeal, offenses, escalationTarget: initialEscalationTarget, permissions }) {
    ...
    async function handlePullReport() {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$report$2f5b$id$5d2f$data$3a$e4b451__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["pullReportAction"])(report.id, pullComment);
        if (result?.error) {
...
//# sourceMappingURL=app_report_%5Bid%5D_7e62b3b2._.js.map